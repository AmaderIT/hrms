...
class RequestLoanUpdate extends FormRequest
{
    /**
    ...
    {
        return [
            "office_division_id"    => "integer|exists:office_divisions,id",
            ...
            "status"                => "in:".implode(",", array(Loan::STATUS_ACTIVE, Loan::STATUS_PAID))
        ];
    }
    ...
    protected function modifyLoanRecords(): void
    {
        ...
        $user = $loan->user->load("currentPromotion");
        $this->request->add([
