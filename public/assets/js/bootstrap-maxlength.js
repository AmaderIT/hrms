...
var KTBootstrapMaxlength = function () {
    ...
    var demos = function () {
        ...
        $('#kt_maxlength_10_modal').maxlength({
            threshold: 3,
            warningClass: "label label-danger label-rounded label-inline",
            limitReachedClass: "label label-success label-rounded label-inline",
            appendToParent: true,
        ...
        $('#kt_maxlength_11_modal').maxlength({
            threshold: 3,
            warningClass: "label label-danger label-rounded label-inline",
            limitReachedClass: "label label-success label-rounded label-inline",
            appendToParent: true,
        ...
        $('#kt_maxlength_12_modal').maxlength({
            threshold: 3,
            warningClass: "label label-danger label-rounded label-inline",
            limitReachedClass: "label label-success label-rounded label-inline",
            appendToParent: true,
        ...
        $('#kt_maxlength_13_modal').maxlength({
            threshold: 3,
            warningClass: "label label-danger label-rounded label-inline",
            limitReachedClass: "label label-success label-rounded label-inline",
            appendToParent: true,
        ...
        $('#kt_maxlength_14_modal').maxlength({
            threshold: 3,
            warningClass: "label label-danger label-rounded label-inline",
            limitReachedClass: "label label-success label-rounded label-inline",
            appendToParent: true,
        ...
        $('#kt_maxlength_15_modal').maxlength({
            threshold: 3,
            warningClass: "label label-danger label-rounded label-inline",
            limitReachedClass: "label label-success label-rounded label-inline",
            appendToParent: true,
        ...
        $('#kt_maxlength_16_modal').maxlength({
            threshold: 3,
            warningClass: "label label-danger label-rounded label-inline",
            limitReachedClass: "label label-success label-rounded label-inline",
            appendToParent: true,
        ...
        $('#kt_maxlength_17_modal').maxlength({
            threshold: 3,
            warningClass: "label label-danger label-rounded label-inline",
            limitReachedClass: "label label-success label-rounded label-inline",
            appendToParent: true,
        ...
        $('#kt_maxlength_18_modal').maxlength({
            threshold: 3,
            warningClass: "label label-danger label-rounded label-inline",
            limitReachedClass: "label label-success label-rounded label-inline",
            appendToParent: true,
        ...
        $('#kt_maxlength_19_modal').maxlength({
            threshold: 3,
            warningClass: "label label-danger label-rounded label-inline",
            limitReachedClass: "label label-success label-rounded label-inline",
            appendToParent: true,
        ...
        $('#kt_maxlength_20_modal').maxlength({
            threshold: 3,
            warningClass: "label label-danger label-rounded label-inline",
            limitReachedClass: "label label-success label-rounded label-inline",
            appendToParent: true,
        ...
        $('#kt_maxlength_21_modal').maxlength({
            threshold: 3,
            warningClass: "label label-danger label-rounded label-inline",
            limitReachedClass: "label label-success label-rounded label-inline",
            appendToParent: true,
