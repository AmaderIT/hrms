        ...
        <div class="col-md-12">
            <div class="card card-custom gutter-b example example-compact">
                <div class="card-header">
                    <h3 class="card-title">Pay Grade</h3>
                ...
                <form action="{{ route('paygrade.update', ['paygrade' => $paygrade->id]) }}" method="POST">
                    @csrf
                    <div class="card-body">
                        <div class="col-md-8 offset-md-2">
                            <div class="form-group">
                                <label for="name">Pay Grade Name <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="name" name="name" value="{{ $paygrade->name }}" {{ old('name') }} required>
                                @error('name')
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="range_start_from" name="range_start_from" value="{{ $paygrade->range_start_from }}" required>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="range_end_to" name="range_end_to" value="{{ $paygrade->range_end_to }}" required/>
                                        @error('range_end_to')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ $paygrade->percentage_of_basic }}"
                                       placeholder="Basic Salary (In Percentage of Gross Salary)" name="percentage_of_basic" list="percentage_of_basic"/>
                                <datalist id="percentage_of_basic">
                                    @for($i = 5; $i <= 100; $i += 5)
                                        <option {{ $paygrade->percentage_of_basic == $i ? 'selected' : '' }}>{{ $i }}</option>
                                    @endfor
                                </datalist>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="overtime_formula" name="overtime_formula"
                                       value="{{$paygrade->overtime_formula}}" {{ old('overtime_formula') }}>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="weekend_allowance_formula" name="weekend_allowance_formula"
                                       value="{{$paygrade->weekend_allowance_formula}}" {{ old('weekend_allowance_formula') }}>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="holiday_allowance_formula" name="holiday_allowance_formula"
                                       value="{{$paygrade->holiday_allowance_formula}}" {{ old('holiday_allowance_formula') }}>
                                            ...
                                            <div class="col-12 col-form-label">
                                                <div class="checkbox-list">
                                                    ...
                                                    @foreach($data["earnings"] as $key => $earning)
                                                        @php
                                                        $payGradeEarning = $paygrade->earnings->where("earning_id", $earning->id)->first();
                                                        @endphp
                                                        <div class="row pt-5">
                                                            <div class="col-lg-3">
                                                            ...
                                                            <div class="col-lg-2">
                                                                <select name="earning_type[]" style="width: 100%;">
                                                                    ...
                                                                    <option value="{{ \App\Models\PayGradeEarning::TYPE_FIXED }}" {{ optional($payGradeEarning)->type === \App\Models\PayGradeEarning::TYPE_FIXED ? "selected" : "" }}>Fixed</option>
                                                                    <option value="{{ \App\Models\PayGradeEarning::TYPE_PERCENTAGE }}" {{ optional($payGradeEarning)->type === \App\Models\PayGradeEarning::TYPE_PERCENTAGE ? "selected" : "" }}>Percentage</option>
                                                                    <option value="{{ \App\Models\PayGradeEarning::TYPE_REMAINING }}" {{ optional($payGradeEarning)->type === \App\Models\PayGradeEarning::TYPE_REMAINING ? "selected" : "" }}>Remaining</option>
                                                                </select>
                                                            </div>
                                                            <div class="col-lg-2">
                                                                <input type="text" style="width: 100%;" name="earning_value[]" value="{{ optional($payGradeEarning)->value }}" placeholder="Value"/>
                                                            </div>
                                                            <div class="col-lg-2">
                                                                <input type="text" style="width: 100%;" name="earning_tax_exempted[]" value="{{ optional($payGradeEarning)->tax_exempted }}" placeholder="Amount"/>
                                                            </div>
                                                            <div class="col-lg-2">
                                                                <input type="text" style="width: 100%;" name="earning_tax_exempted_percentage[]" value="{{ optional($payGradeEarning)->tax_exempted_percentage }}" placeholder="Percentage"/>
                                                            </div>
                                                            <div class="col-lg-1">
                                                                <label class="checkbox">
                                                                    <input type="hidden" name="earning_non_taxable[{{ $key }}]" value="0"/>
                                                                    <input type="checkbox" style="width: 100%;" name="earning_non_taxable[{{ $key }}]" value="1" {{ optional($payGradeEarning)->non_taxable == 1 ? "checked" : "" }}/>
                                                                    <span></span> Cash
                                                                </label>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-12 col-form-label">
                                                <div class="checkbox-list">
                                                    ...
                                                    @foreach($data["deductions"] as $key => $deduction)
                                                        @php
                                                            $payGradeDeduction = $paygrade->deductions->where("deduction_id", $deduction->id)->first();
                                                        @endphp
                                                        <div class="row pt-5">
                                                            <div class="col-lg-3">
                                                            ...
                                                            <div class="col-lg-2">
                                                                <select name="deduction_type[]" style="width: 100%;">
                                                                    <option value="" selected>Type</option>
                                                                    <option value="{{ \App\Models\PayGradeDeduction::TYPE_FIXED }}" {{ optional($payGradeDeduction)->type === \App\Models\PayGradeDeduction::TYPE_FIXED ? "selected" : "" }}>Fixed</option>
                                                                    <option value="{{ \App\Models\PayGradeDeduction::TYPE_PERCENTAGE }}" {{ optional($payGradeDeduction)->type === \App\Models\PayGradeDeduction::TYPE_PERCENTAGE ? "selected" : "" }}>Percentage</option>
                                                                </select>
                                                            </div>
                                                            <div class="col-lg-2">
                                                                <input type="text" style="width: 100%;" name="deduction_value[]" value="{{ optional($payGradeDeduction)->value }}" placeholder="Value"/>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-6 col-form-label">
                                        ...
                                        <label class="checkbox ml-3">
                                            <input type="checkbox" name="tax_id" value="1" {{ $paygrade->tax_id != \App\Models\Tax::STATUS_INACTIVE ? "checked" : "" }}>
