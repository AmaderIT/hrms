    ...
    <div class="card card-custom">
        ...
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">Promotion Listing</h3>
            </div>
            <div class="card-toolbar">
                ...
                @can('Create Promotion')
                    <a href="{{ route('promotion.create') }}" class="btn btn-primary font-weight-bolder">
...
@section('footer-js')
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#dataTable').DataTable({
                ...
                "columns": [
                    ...
                    {
                        "data": function (row, type, set) {
                            if (type === 'display' && row.pay_grade) {
                                return row.pay_grade.name;
                            }
                            return '';
                        },
                        "name": "payGrade.name",
        ...
        $(".saveAsExcel").click(function () {
            exportXcel("Promotion Listing", "dataTable", "Action")
        })
