        ...
        <div class="col-md-7">
            <div class="card card-custom gutter-b example example-compact">
                <div class="card-header">
                    <h3 class="card-title">Add New Loan / Advance</h3>
                ...
                <form action="{{ empty($loan)? route('requested-loan-advance.store'): route('requested-loan-advance.update', ['loan' => $loan->uuid]) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="office_division_id" name="office_division_id"
                                        ...
                                        @foreach($officeDivisions as $officeDivisionId => $officeDivisionName)
                                            <option
                                                value="{{ $officeDivisionId }}" {{ $officeDivisionId == old("office_division_id") ? 'selected' : '' }}>
                                                {{ $officeDivisionName }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="user_id" name="user_id" required="required">
                                        ...
                                        @foreach($users as $user)
                                            <option
                                                value="{{ $user->id }}" {{ (!empty(old('user_id')) && $user->id == old('user_id'))? 'selected': '' }}>
...
@section('footer-js')
    ...
    <script type="text/javascript">
        ...
        $('#loan_amount, #loan_tenure, .installment_start_month, .type, #user_id',).on('change', function () {
