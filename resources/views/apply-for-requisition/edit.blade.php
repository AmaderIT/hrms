    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card card-custom gutter-b example example-compact">
                ...
                <!--begin::Form-->
                <form action="{{ route('apply-for-requisition.update', ['requisition' => $data['requisition']->id]) }}" method="POST">
                    @csrf
                    <div class="card-body">
                                    ...
                                    <div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-2">
                                                ...
                                                <input type="number" class="form-control" name="quantity[]" value="{{ $data['requisition']->details[$i]->quantity }}"
                                                       placeholder="Enter quantity here" readonly {{ $i == 0 ? "required" : "" }}>
                                                @error('quantity')
                                            ...
                                            <div class="col-lg-2">
                                                ...
                                                <input type="number" class="form-control" value="{{ $data['requisition']->details[$i]->received_quantity }}"
                                                       placeholder="Enter quantity here" {{ $i == 0 ? "required" : "" }} readonly>
                                                @error('received_quantity')
                                                <p class="text-danger"> {{ $errors->first("received_quantity") }} </p>
                                                @enderror
                                            </div>
                                            <div class="col-lg-2">
                                                <label>Provide Quantity<span class="text-danger">*</span></label>
                                                <input type="number" class="form-control" name="received_quantity[]" value="0"
                                                       placeholder="Enter quantity here" {{ $i == 0 ? "required" : "" }}>
                                                @error('received_quantity')
                                                <p class="text-danger"> {{ $errors->first("received_quantity") }} </p>
                                                @enderror
                                            </div>
                                    ...
                                    <div data-repeater-list="">
                                        <div data-repeater-item="" class="section-repeater">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-2">
                                                    <label>Received Quantity <span class="text-danger">*</span></label>
                                                    <input type="number" class="form-control" placeholder="Enter quantity here" {{ $i == 0 ? "required" : "" }}>
                                                    @error('received_quantity')
                                                    <p class="text-danger"> {{ $errors->first("received_quantity") }} </p>
                                                    @enderror
                                                </div>
