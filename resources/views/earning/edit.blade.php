    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card card-custom gutter-b example example-compact">
                ...
                <form action="{{ route('earning.update', ['earning' => $earning->id]) }}" method="POST">
                    @csrf
                    <div class="card-body">
                        <div class="col-md-8 offset-md-2">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name" name="name" value="{{ $earning->name }}" {{ old('name') }} required>
                                @error('name')
