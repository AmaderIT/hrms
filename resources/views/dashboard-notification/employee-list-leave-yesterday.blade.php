            ...
            <div class="card card-custom card-stretch gutter-b">
                ...
                <div class="card-header border-0 pt-7">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label font-weight-bold font-size-h4 text-dark-75">Employee Listing</span>
                    </h3>
    ...
    <script>
        $(document).ready(function () {
            $('#dashboardEmployeeTable').DataTable({
                ...
                "ajax": {
                    "method": "POST",
                    "url": '{{route("dashboard-notification.get-employee-list-data-leave-yesterday")}}',
                    "data": {
                        room: '{{$request->room?? ''}}'
                    }
                },
