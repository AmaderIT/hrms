        ...
        <div class="card-body">
            <table class="table" id="dataTable">
                ...
                <tr>
                    ...
                    <th width="20%" scope="col">Group</th>
                    <th width="60%" scope="col">Roles</th>
        ...
        $(document).ready(function () {
            ...
            $('#dataTable').DataTable({
                ...
                "columns": [
                    ...
                    {"data": "roles", "name": "roles", orderable: false, sortable: false, searchable: false},
                    {"data": "users", "name": "users", orderable: false, sortable: false, searchable: false},
