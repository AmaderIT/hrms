        ...
        <div class="col-md-12">
            <div class="card card-custom gutter-b example example-compact">
                <div class="card-header">
                    <h3 class="card-title">Generate Bonus</h3>
                </div>
                <form action="{{ route('user-bonus.store') }}" method="POST">
                    @csrf
                    <div class="card-body">
                        <div class="col-md-8 offset-md-2">
                            ...
                            <div class="form-group">
                                <label for="bonus_id">Bonus Name <span style="color: red"> *</span></label>
                                <select class="form-control" id="bonus_id" name="bonus_id" required>
                                    <option value="" selected="selected">Select</option>
                                    @foreach($data["bonuses"] as $bonusId => $bonusTitle)
                                        <option value="{{ $bonusId }}" {{ $bonusId == old("bonus_id") ? 'selected' : '' }}>
                                            {{ $bonusTitle }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                <label class="checkbox checkbox-success">
                                    <input type="checkbox" name="tax" id="overtime" />
