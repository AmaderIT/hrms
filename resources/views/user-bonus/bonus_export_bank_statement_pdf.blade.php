                    ...
                    <div class="card-body">
                        <table class="table table-bordered table-condensed text-center">
                            ...
                            @foreach($bonuses as $key => $bonus)
                                @php($netPayable += $bonus->net_payable_amount)
                                <tr>
                                    <td>{{ $key + 1 }}</td>
                                    <td>{{ $bonus->user->fingerprint_no }}</td>
                                    <td>{{ $bonus->user->currentBank->account_name ?? "" }}</td>
                                    <td>{{ $bonus->user->currentBank->account_no ?? "" }}</td>
                                    <td>{{ \App\Http\Controllers\SalaryController::currencyFormat($bonus->net_payable_amount,'BHD') ?? "" }}</td>
