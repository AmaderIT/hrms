    ...
    <div class="card card-custom">
        ...
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">Department Listing</h3>
            </div>
            <div class="card-toolbar">
                <!--begin::Button-->
                @can('Create New Department')
                    <a href="{{ route('department.create') }}" class="btn btn-primary font-weight-bolder">
                    ...
                    <tr>
                        ...
                        <td>
                            @can('Edit Department Name')
                                <a href="{{ route('department.edit', ['department' => $item->id]) }}"><i
                                        class="fa fa-edit" style="color: #008000"></i></a> ||
                            @endcan
                            @can('Delete Department Name')
                                <a href="#"
                                   onclick="deleteAlert('{{route('department.delete', ['department' => $item->id])}}')"><i
...
@section('footer-js')
    <script>
        $(document).ready(function () {
            ...
            $("input[name=search]").val("{{\Illuminate\Support\Facades\Request::get('search')}}")
        });
    </script>
@endsection
