    ...
    <div class="card card-custom">
        ...
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">Supervisor Listing
                </h3>
            </div>
            <div class="card-toolbar">
                @can('Create Supervisor')
                <a href="{{ route('supervisor.create') }}" class="btn btn-primary font-weight-bolder">
    ...
    <script>
        $(document).ready(function () {
            $('#employeeTable').DataTable({
                ...
                "ajax": {
                    "method": "POST",
                    "url": '{{ route("supervisor.datatable") }}',
                },
                "columns": [
                    {
        ...
        function showListsDepartmentWise(id) {
            if (id == '') {
                alert("Missing ID!!!");
                return false;
            }
            ...
            $.ajax({
                url: '{{ route("supervisor.listsDepartmentWise") }}',
                type: 'POST',
        ...
        function showListsOfficeDivisionWise(id) {
            ...
            let $responseStatus = false;
            $.ajax({
                url: '{{ route("supervisor.listsOfficeDivisionWise") }}',
                type: 'POST',
