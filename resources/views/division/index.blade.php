        ...
        <div class="card-header flex-wrap pt-6 pb-6">
            ...
            <div class="card-toolbar">
                ...
                <div class="dropdown dropdown-inline mr-2">
                    ...
                    <a href="{{route('division.export')}}" data-toggle="tooltip" title="Export">
                ...
                <a href="{{ route('division.create') }}" class="btn btn-primary font-weight-bolder">
            ...
            <table class="table" id="divisionTable">
                ...
                @foreach($items as $item)
                    <tr>
                        <td>{{ $item->name }}</td>
                        <td>
                            @can('Edit Divisions Name')
                            <a href="{{ route('division.edit', ['division' => $item->id]) }}"><i class="fa fa-edit" style="color: green"></i></a> ||
                            @endcan
                            @can('Delete Divisions')
                            <a href="#" onclick="deleteAlert('{{route('division.delete', ['division' => $item->id])}}')" ><i class="fa fa-trash" style="color: red"></i></a>
                            @endcan
                        </td>
                    </tr>
                @endforeach
