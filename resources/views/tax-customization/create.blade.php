        ...
        <div class="col-md-12">
            ...
            <div class="card card-custom gutter-b example example-compact">
                <div class="card-header">
                    <h3 class="card-title">Tax Customization</h3>
                </div>
                <!--begin::Form-->
                <form action="{{ route('tax-customization.store') }}" method="POST">
                    @csrf
                    <div class="card-body">
                        <div class="col-md-8 offset-md-2">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="user_id" id="user_id">
                                    ...
                                    @foreach($users as $user)
                                        <option value="{{ $user->id }}">{{ $user->name . " - " . $user->fingerprint_no }}</option>
                                    @endforeach
                                </select>
                                @error('user_id')
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="requested_amount" placeholder="Enter requested amount here" required>
