    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">Requested Online Attendances</h3>
            </div>
        </div>
            ...
            <div class="col-md">
                <div class="form-group">
                    ...
                    <select class="form-control ml-2 w-75" id="status" name="status">
                        ...
                        <option value="{{\App\Models\OnlineAttendance::PENDING}}">Pending</option>
                        <option value="{{\App\Models\OnlineAttendance::AUTHORIZED}}">Authorized</option>
                        <option value="{{\App\Models\OnlineAttendance::APPROVED}}">Approved</option>
                        <option value="{{\App\Models\OnlineAttendance::REJECTED}}">Rejected</option>
                    </select>
                </div>
            </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            dataTable = $('#applicationTable').DataTable({
                ...
                responsive: true,
                ajax: {
                    ur: '{{ route('attendance.requested_online_attendances.index') }}',
                    data: function (d) {
                        if (f == 1) {
