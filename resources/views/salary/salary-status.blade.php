...
@section('content')
                ...
                <div class="row m-auto">
                    <div class="row col-12 justify-content-start mb-2">
                        <div class="col-4">
                            ...
                            <input class="mb-2 w-100" type="text" name="datepicker" id="datepicker" placeholder="Select Month" autocomplete="off" style="height: 30px;" required/>
                        </div>
    ...
    <div class="row">
        <div class="col-xxl-12">
            <form action="{{ route('salary.paySalaryByDepartment')  }}" method="post">
            @csrf
                <input type="hidden" name="year_alone" value="{{ request()->year_alone  }}">
            ...
            <div class="card card-custom card-stretch gutter-b">
                ...
                <div class="card-body pt-0 pb-4">
                    <div class="card-body">
                        <table class="table table-responsive-lg" id="leaveRequestToAdmin{{ $key1 }}">
                            ...
                            <tr>
                                <th scope="col">
                                    <input type="checkbox" name="select_all[]" id="selectAll" class="selectAll"/>
                                </th>
                            ...
                            <tbody id="resultData">
                                @foreach($months as $key2 => $month)
                                    ...
                                    <tr>
                                        @if($month["status"] === "0")
                                        <td><input type="checkbox" name="department_id[]" value="{{ $month["department_id"] }}" class="salaryDepartmentID" onclick="salaryDepartmentID()" /> </td>
                                        @else
                                        <td></td>
                                        @endif
                ...
                <div class="card-footer">
                    <div class="row">
                        ...
                        <div class="col-lg-1">
                            <button type="submit" class="btn btn-primary" id="paySalaryByDepartment" class="paySalaryByDepartment">Pay</button>
                        </div>
                    </div>
                </div>
                @endif
