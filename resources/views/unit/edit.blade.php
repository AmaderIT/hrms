                    ...
                    <div class="card-body">
                        <div class="col-md-8 offset-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="kt_maxlength_1" minlength="3" maxlength="50" name="name" placeholder="Enter bank name here"
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" rows="5" name="description" placeholder="Enter unit name here">{!! $unit->description !!}</textarea>
                                @error('description')
