    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-custom gutter-b example example-compact">
                ...
                <form id="saveForm" action="{{ route('internal-transfer.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="col-md-8 offset-md-2">
                            <div class="form-group">
                                <label for="issue_at">Issue Date Time <span class="text-danger">*</span></label>
                                <input type="datetime-local" value="{{ date('Y-m-d\TH:i') }}" class="form-control"
                        ...
                        <div class="col-md-8 offset-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="reference" value="" class="form-control" placeholder="Enter reference here">
                                @error('reference')
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="delivered_by" name="delivered_by" required>
                                    ...
                                    @foreach($data["employees"] as $employee)
                                        <option value="{{ $employee->id }}" {{ $employee->id == old("delivered_by") ? 'selected' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <div class="radio-inline">
                                    <label class="radio radio-default d-none">
                                        <input type="radio" name="transfer_from" value="warehouse" class="transfer_from">
                                        <span></span>Warehouse</label>
                                    <label class="radio radio-default">
                                        <input type="radio" name="transfer_from" value="department" class="transfer_from" checked="checked">
                        ...
                        <div class="col-md-8 offset-md-2 d-none" id="source_warehouse">
                            <div class="form-group">
                        ...
                        <div class="col-md-8 offset-md-2" id="source_department">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="source_department_id" name="source_department_id" required>
                                    ...
                                    @else
                                        @if(isset($data["departments_divisions"]))
                                            ...
                                            @foreach($data["departments_divisions"] as $department)
                                                @if(!$department->is_warehouse)
                                                    <option value="{{ $department->id }}" {{ $department->id == old("source_department_id") ? 'selected' : '' }}>
                                                        {{ $department->name }}
                                                    </option>
                                                @endif
                                            @endforeach
                        ...
                        <div class="col-md-8 offset-md-2">
                            <div class="form-group">
                                ...
                                <div class="radio-inline">
                                    <label class="radio radio-default d-none">
                                        <input type="radio" name="transfer_to" value="warehouse" class="transfer_to">
                                        <span></span>Warehouse</label>
                                    <label class="radio radio-default">
                                        <input type="radio" name="transfer_to" value="department" class="transfer_to" checked="checked">
                                        <span></span>Department</label>
                                    <label class="radio radio-default">
                                        <input type="radio" name="transfer_to" value="supplier" class="transfer_to">
                        ...
                        <div class="col-md-8 offset-md-2 d-none" id="destination_warehouse">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="destination_warehouse_id" name="destination_warehouse_id">
                                    <option value="" selected>Select an option</option>
                                    @foreach($data["warehouses"] as $warehouse)
                                        <option value="{{ $warehouse->id }}" {{ $warehouse->id == old("destination_warehouse_id") ? 'selected' : '' }}>
                                            {{ $warehouse->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-8 offset-md-2" id="destination_department">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="destination_department_id" name="destination_department_id">
                                    ...
                                    @foreach($data["departments"] as $department)
                                        @if($data['department_id']!=$department->id)
                                            <option value="{{ $department->id }}" {{ $department->id == old("destination_department_id") ? 'selected' : '' }}>
                                                {{ $department->name }}
                                            </option>
                                        @endif
                                    @endforeach
                        ...
                        <div class="col-md-8 offset-md-2 d-none" id="destination_supplier">
                            <div class="form-group">
                                <label for="destination_supplier_id">Destination Supplier
                                    (<i style="font-size: 12px;text-decoration: underline;color: lightskyblue;cursor: pointer" class="type_supplier">Click here for new supplier</i>)
                                ...
                                <div class="supplier_div" data-value="select">
                                    <select class="form-control" id="destination_supplier_id" name="to_supplier_id">
                                        ...
                                        @foreach($data["suppliers"] as $supplier)
                                            <option value="{{ $supplier->id }}" {{ $supplier->id == old("to_supplier_id") ? 'selected' : '' }}>
                                                {{ $supplier->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="radio-inline">
                                    <label class="radio radio-primary">
                                        <input type="radio" name="is_returnable" value="1">
                                        <span></span>Yes</label>
                                    <label class="radio radio-primary">
                                        <input type="radio" name="is_returnable" checked="checked" value="0">
                                        <span></span>No</label>
                                </div>
                                @error('is_returnable')
                        ...
                        <div class="col-md-8 offset-md-2">
                            <div class="form-group">
                                <label for="challan">Attachment</label>
                                            ...
                                            <div data-repeater-item="" class="section-repeater">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-lg-4 challanItemsDiv">
                                                        ...
                                                        <input type="text" autocomplete="off" class="form-control search" name="search[]" placeholder="Item Name" required>
                                                        <input type="hidden" class="form-control challan_item_name" name="item[]" value="">
                                                        <input type="hidden" class="challan_item_type" name="item_type[]" value="">
                                                    ...
                                                    <div class="col-lg-2 challanItemsUnitDiv">
                                                        <label>UOM</label>
                                                        <input type="text" class="form-control unit_class" disabled value="---">
                                                        <input type="hidden" class="form-control unit_input_class" name="unit[]" value="">
                                                    </div>
                                                    <div class="col-lg-2">
                                                        <label>Qty <span class="text-danger">*</span></label>
                                                        <input type="number" class="form-control qty_class" name="qty[]" value="0" required/>
                                                        @error("qty")
                                                    ...
                                                    <div class="col-lg-2">
                                                        <label>Remarks</label>
                                                        <input name="remarks[]" type="text" class="form-control" placeholder="Result"/>
                                                        @error("remarks")
