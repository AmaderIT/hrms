    ...
    <div class="col-12">
        <div class="row">
            <div class="col-md-6">
                ...
                @elseif($challan->to_supplier_id>0)
                    <div class="col-md-12" id="">
                        <div class="form-group mb-1">
                            <label for="" style="font-weight: 600 !important;">Transferred To:</label>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @else
                        ...
                        @if(($challan->status == 1) && auth()->user()->can('Security CheckIn Internal Transfer'))
                        <label>
                            <input type="radio" class="action" name="action" value="approve"/>
                            Checked In
                        </label>
                        ...
                        @if($challan->status == 1 && auth()->user()->can('Reject Internal Transfer'))
                        ...
                        <form class="approve" action="{{route('internal-transfer.approvalAction')}}" method="POST" style="display: none">
                            ...
                            <div class="mt-2">
                                ...
                                @if(($challan->status == 1) && auth()->user()->can('Security CheckIn Internal Transfer'))
                                    <input type="hidden" value="4" name="status" required>
                            </div>
                            <button type="submit" id="ApproveBtn" class="btn btn-sm btn-info mt-2">Submit</button>
                            @elseif($challan->status == 4 && auth()->user()->can('Receive Internal Transfer'))
                                <input type="hidden" value="5" name="status" required>
