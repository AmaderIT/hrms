        ...
        <div class="col-md-12">
            ...
            <div class="card card-custom gutter-b example example-compact">
                <div class="card-header">
                    <h3 class="card-title">Edit Bonus Setting</h3>
                ...
                <!--begin::Form-->
                <form action="{{ route('bonus.update', ['bonus' => $bonus->id]) }}" method="POST">
                    @csrf
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label for="festival_name">Bonus Name</label>
                                        <input type="text" value="{{ $bonus->festival_name }}" id="festival_name" class="form-control"
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="type" name="type">
                                            <option value="{{ \App\Models\Bonus::TYPE_BASIC }}" {{ \App\Models\Bonus::TYPE_BASIC == $bonus->type ? "selected": "" }}>
                                                {{ \App\Models\Bonus::TYPE_BASIC }}
                                            </option>
                                            <option value="{{ \App\Models\Bonus::TYPE_GROSS }}" {{ \App\Models\Bonus::TYPE_GROSS == $bonus->type ? "selected": "" }}>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control effective_date datepicker"
                                               style="width: 100%"
                                               value="{{ !empty($bonus->effective_date)? date('Y-m-d', strtotime($bonus->effective_date)): old('effective_date') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="employment_period_one"
                                            ...
                                            @foreach(\App\Models\Bonus::EMPLOYMENT_PERIODS as $periodId => $periodName)
                                                ...
                                                <option
                                                    value="{{ $periodId }}" {{ ($periodId == \App\Models\Bonus::SIX_MONTH? 'selected': '') }}>{{ $periodName }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="percentage_one">Percentage <span
                                                class="text-danger">*</span></label>
                                        <input type="number" value="{{ !empty($paymentDetails[\App\Models\Bonus::SIX_MONTH])? $paymentDetails[\App\Models\Bonus::SIX_MONTH]: old('percentage_one') }}" min="1" max="100" id="percentage_one"
                                               class="form-control"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="employment_period_two"
                                            ...
                                            @foreach(\App\Models\Bonus::EMPLOYMENT_PERIODS as $periodId => $periodName)
                                                ...
                                                <option
                                                    value="{{ $periodId }}" {{ ($periodId == \App\Models\Bonus::THREE_MONTH? 'selected': '') }}>{{ $periodName }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="percentage_two">Percentage <span
                                                class="text-danger">*</span></label>
                                        <input type="number" value="{{ !empty($paymentDetails[\App\Models\Bonus::THREE_MONTH])? $paymentDetails[\App\Models\Bonus::THREE_MONTH]: old('percentage_two') }}" min="1" max="100" id="percentage_two"
                                               class="form-control"
