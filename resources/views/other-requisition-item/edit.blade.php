        ...
        <div class="col-md-12">
            <div class="card card-custom gutter-b example example-compact">
                <div class="card-header">
                    <h3 class="card-title">Edit Challan Item</h3>
                ...
                <form action="{{ route('other-requisition-item.update', ['otherRequisitionItem' => $otherRequisitionItem->id]) }}" method="POST">
                    @csrf
                    <div class="card-body">
                        <div class="col-md-8 offset-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="kt_maxlength_1" minlength="3" maxlength="50" name="name" placeholder="Enter requisition item name here"
                                       value="{{ old('name') ?: $otherRequisitionItem->name }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="kt_maxlength_1" minlength="0" maxlength="50" name="code" placeholder="Enter requisition item code here"
                                       value="{{ old('code') ?: $otherRequisitionItem->code }}">
